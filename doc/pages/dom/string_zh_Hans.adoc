...
* redundant overloads for string operations have been replaced with a <<ref_string_view>>-based interface,
...
* a parameter of a type convertible to <<ref_string_view>> and two `size_type` parameters that specify a substring, or
